...
- **`status="validated"`** — ONLY if you performed a `wpguard_sandbox_request()` that confirms the vulnerability (e.g., file contents returned in response via path traversal, remote file included and executed)
